...
<!-- 			href is acting as an action and providing parameters. the "?" separates the action from the parameter  (action is "photolink"..photo.url is parameter) (the below line)	
